...
outfile_name = "results/results_bow_tfidf_balanced_" + cur_time.replace(" ", "_") + ".txt"
with codecs.open(outfile_name, 'w') as fp:
        fp.write("balanced bag of words+tfidf accuracy: " + str(accuracy) + "   num samples: " + str(data.shape[0]) + "\n")
